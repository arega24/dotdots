...
# bspwm
sudo paru -S bspwm sxhkd rofi polybar picom python-pywal kitty dunst playerctl pamixer pulsemixer qpwgraph zip tar bat mediainfo ueberzug trash-cliredshift-minimal rofi-calc 
